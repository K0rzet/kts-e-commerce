...
const ThemeIcon = ({ onClick, isLight, className }: { onClick: () => void; isLight: boolean; className?: string }) => {
  return (
    <button onClick={onClick} className={classNames(styles.themeButton, className)}>
      {isLight ? (
        ...
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            d="M4.92999 4.92999L6.33999 6.33999"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
